    ...
    >
      ...
      <g clip-path="url(#mark-squircle)">
        ...
        <g filter="url(#mark-glow)">
          <path
            d="M178 180 L118 256 L178 332"
            fill="none"
            stroke="url(#mark-bracket)"
            stroke-width="22"
    ...
    >
      ...
      <g clip-path="url(#splash-squircle)">
        ...
        <g filter="url(#splash-glow)">
          ...
          />
          <path
            d="M175 188 L122 256 L175 324"
            fill="none"
            stroke="url(#splash-inner)"
            stroke-width="8"
            stroke-linecap="round"
            stroke-linejoin="round"
            opacity="0.35"
